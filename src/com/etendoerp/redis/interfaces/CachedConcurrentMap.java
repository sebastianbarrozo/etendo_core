 ...
 * @param <V>
 *     the type of mapped values. They must be Serializable to support Redis usage (refer to the Redisson documentation).
 */
public class CachedConcurrentMap<K, V> implements ConcurrentMap<K, V> {
   ...
   *
   * @param name
   *     key to use in Redis. (This is not used when Redis is not configured.)
   */
   ...
   *     key to use in Redis. (This is not used when Redis is not configured.)
   * @param localCache
   *     whether to use {@link org.redisson.api.RLocalCachedMap} or a {@link org.redisson.api.RMap}
   */
   ...
   *     whether to use {@link org.redisson.api.RLocalCachedMap} or a {@link org.redisson.api.RMap}
   * @param options
   *     {@link LocalCachedMapOptions} cache options. Only used when localCache is true
   */
   ...
   *     map initial capacity. Only used when Redis is not available
   */
  public CachedConcurrentMap(String name, boolean localCache, LocalCachedMapOptions<K, V> options,
